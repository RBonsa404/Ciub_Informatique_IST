...
public class JwtService {
    ...
    public String generateTempToken(String email, long tempExpirationMs) {
        Map<String, Object> claims = new HashMap<>();
        claims.put("type", "2FA_TEMP");
        return generateToken(claims, email, tempExpirationMs);
    }
    ...
    public boolean isTempTokenValid(String token) {
        try {
            ...
            return "2FA_TEMP".equals(claims.get("type")) && !isTokenExpired(token);
        } catch (Exception e) {
            return false;
        }
    }
